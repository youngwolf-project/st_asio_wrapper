...
//		do_something_to_all(total_recv_bytes += boost::lambda::bind(&test_socket::get_recv_bytes, *boost::lambda::_1));
	...
	void shutdown_some_client(int n)
	{
		...
		case 0: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::graceful_shutdown, *boost::lambda::_1, false, true)));	break;
		case 1: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::graceful_shutdown, *boost::lambda::_1, false, false)));	break;
		case 2: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::force_shutdown, *boost::lambda::_1, false)));				break;
#else
			//method #2
		...
		case 3: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::graceful_shutdown, *boost::lambda::_1, true, true)));		break;
		case 4: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::graceful_shutdown, *boost::lambda::_1, true, false)));	break;
		case 5: do_something_to_all(boost::lambda::if_then(boost::lambda::var(n)-- > 0, boost::lambda::bind(&test_socket::force_shutdown, *boost::lambda::_1, true)));				break;
		}
	}

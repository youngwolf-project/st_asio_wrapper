...
{
public:
	static const unsigned char TIMER_BEGIN = st_connector_base<Packer, Unpacker, Socket>::TIMER_END;
...
private:
	...
	void connect_handler(const boost::system::error_code& ec)
	{
		...
		{
			int delay = ST_THIS prepare_reconnect(ec);
			if (delay >= 0)
				ST_THIS set_timer(TIMER_CONNECT, delay, boost::bind(&st_ssl_connector_base::reconnect_handler, this, _1));

...
protected:
	...
	void dispatch_msg()
	{
		...
		BOOST_AUTO(begin_time, boost::date_time::microsec_clock<boost::posix_time::ptime>::local_time());
		...
		BOOST_AUTO(time_duration, boost::date_time::microsec_clock<boost::posix_time::ptime>::local_time() - begin_time);
